...
function xmljson(){
    ...
    document.getElementById("assertions").innerHTML = '--------copy and paste the relevant assertions into your script -------------<br/><br/>' +text.substring(0, textLength - 14) + ';';
}
...
function myFunction() {
    if(IsJsonString(document.getElementById('inputJson').value))
    {
        ...
        document.getElementById("assertions").innerHTML += json2txt(myObj, '');
        var text = document.getElementById("assertions").innerHTML;
        var textLength = text.trim().length;
        document.getElementById("assertions").innerHTML = '--------copy and paste the relevant assertions into your script -------------<br/><br/>' +text.substring(0, textLength - 14) + ';';
    } 
    ...
    {
        document.getElementById("assertions").innerHTML = "<span style='color:red'>  Not valid JSON </span>";
    }
}
...
function prettyPrint() {
    ...
    if(IsJsonString(document.getElementById('inputJson').value))
    {
        ...
        document.getElementById("assertions").innerHTML = "<span style='color:green'> JSON is well structured </span>";
    } 
    else 
    {
        document.getElementById("assertions").innerHTML = "<span style='color:red'>  Not valid JSON </span>";
