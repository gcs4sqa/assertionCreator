...
var xmlToJson = (function () {
  ...
  self.parseAttributes = function (node) {
    ...
    //cliff douglas - removed returned obj to prevent the inclusion of the tag attribute
    //console.log(obj);
    return null;
    //return obj;
  };
  ...
  self.parseNode = function (parent, node) {
    ...
    if (node.childNodes.length == 1 && node.childNodes[0].nodeType == 3) 
    {
      ...
      if (node.hasAttributes()) 
      {
        //cliff douglas - removed the adding of an additional property when a tag has an attribute
  ...
  this.parseValue = function (val) {
    ...
    //cliff douglas - removed to force booleans to return as a string
    /*
...
*/
    ...
    //cliff douglas - removed to force all non booleans to returns as a string.
